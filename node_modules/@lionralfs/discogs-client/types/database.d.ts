...
import { type Image, type GetReleaseResponse, type RateLimitedResponse, type Artist, type Tracklisting, type PaginationParameters, type Currency, type SortParameters, type PaginationResponse, type Status } from './types.js';
...
export type GetReleaseRatingResponse = {
    username: string;
    release_id: number;
    rating: number;
};
export type GetReleaseCommunityRatingResponse = {
    rating: {
        count: number;
        average: number;
    };
...
export type GetReleaseStatsResponse = {
    num_have: number;
    num_want: number;
};
...
export default function (client: DiscogsClient): {
     ...
     */
    getArtist: (artist: number | string) => Promise<RateLimitedResponse<GetArtistResponse>>;
    /**
     ...
     */
    getArtistReleases: (artist: number | string, params?: PaginationParameters & SortParameters<"year" | "title" | "format">) => Promise<RateLimitedResponse<GetArtistReleasesResponses & PaginationResponse>>;
    /**
     * Get release data
     ...
     */
    getRelease: (release: number | string, currency?: Currency) => Promise<RateLimitedResponse<GetReleaseResponse>>;
    /**
     ...
     */
    getReleaseRating: (release: number | string, user: string) => Promise<RateLimitedResponse<GetReleaseRatingResponse>>;
    /**
     ...
     */
    setReleaseRating: (release: number | string, user: string, rating: 1 | 2 | 3 | 4 | 5 | null) => Promise<RateLimitedResponse<GetReleaseRatingResponse | void>>;
    /**
     ...
     */
    getReleaseCommunityRating: (release: number | string) => Promise<RateLimitedResponse<GetReleaseCommunityRatingResponse>>;
    /**
     ...
     */
    getReleaseStats: (release: number | string) => Promise<RateLimitedResponse<GetReleaseStatsResponse>>;
    /**
     ...
     */
    getMaster: (master: number | string) => Promise<RateLimitedResponse<GetMasterResponse>>;
    /**
     ...
     * });
     */
    getMasterVersions: (master: number | string, params?: PaginationParameters & Partial<{
        format: string;
        label: string;
        released: string;
        country: string;
    } & SortParameters<"released" | "title" | "format" | "label" | "catno" | "country">>) => Promise<RateLimitedResponse<GetMasterVersionsResponse & PaginationResponse>>;
    /**
     * Get label data
     ...
     */
    getLabel: (label: number | string) => Promise<RateLimitedResponse<GetLabelResponse>>;
    /**
     ...
     */
    getLabelReleases: (label: number | string, params?: PaginationParameters) => Promise<RateLimitedResponse<GetLabelReleasesResponse & PaginationResponse>>;
    /**
     * Search the database
     ...
     * });
     */
    search: (params?: PaginationParameters & Partial<SearchParameters>) => Promise<RateLimitedResponse<SearchResponse & PaginationResponse>>;
};
