...
export default function (client: DiscogsClient): {
     ...
     */
    exportInventory: () => Promise<RateLimitedResponse<void>>;
    /**
     ...
     */
    getExports: (params?: PaginationParameters) => Promise<RateLimitedResponse<GetInventoryExportsResponse & PaginationResponse>>;
    /**
     ...
     */
    getExport: (id: number) => Promise<RateLimitedResponse<GetInventoryExportResponse>>;
    /**
     ...
     */
    downloadExport: (id: number) => Promise<RateLimitedResponse<Response>>;
};
